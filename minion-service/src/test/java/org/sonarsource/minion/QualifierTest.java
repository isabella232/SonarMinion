...
public class QualifierTest {
  ...
  public void request_jira() {
    Set<String> response = new Qualifier().qualify(Collections.singleton("Caused by: java.lang.UnsupportedOperationException: a measure can be set only once for a specific Component"), new HashMap<>());
